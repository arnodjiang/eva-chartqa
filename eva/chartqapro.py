...
def load_predictions(file_path):
    ...
    with open(file_path, "r", encoding="utf-8") as f:
        for line in f:
            to_data.append(json.loads(line))
    return to_data
...
def main():
    """
    pip install anls json5
    python /hy57/konghua/project/eccv-chart/utils/chartQaPro.py --predictions-file /hy57/konghua/project/eccv-chart/gits/test_output.jsonl
    """
